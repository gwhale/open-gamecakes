...
const MATH_GROUPS: {
  ...
  },
  {
    ...
    types: [
      ...
      // Was "Tens and ones", which stopped being true when the four-digit band
      // opened at tier 5 — a third grader picking it gets 3,486, not 34.
      { value: 'place-value', label: 'Which place?',       emoji: '🔟' },
      { value: 'skip-count',  label: 'Counting patterns',  emoji: '👣' },
      { value: 'rounding',    label: 'Round it off',       emoji: '🎯' },
