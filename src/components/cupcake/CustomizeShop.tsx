  ...
  return (
    <main className="relative flex flex-1 flex-col items-center overflow-hidden bg-gradient-to-br from-rose-50 via-amber-50 to-sky-100 p-4 sm:p-6 dark:from-zinc-950 dark:to-zinc-900">
      ...
      <header className="relative z-10 flex w-full max-w-2xl items-center justify-between">
        {/* The store's nav corner. The collection sits here rather than as a
            fifth catalog tab because the tabs are TabKey — a union of cupcake
            parts you BUY, keyed into ALL_OPTIONS, findCost and the unlock POST.
            Items are found, not bought, and have no cost, so shoehorning them
            into that union would mean four Records carrying a member that can
            never be purchased. */}
