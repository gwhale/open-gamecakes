// `/games/sandcastle-siege` — 3D water-balloon demolition with math gates.
...
import SandcastleSiegeShell from './SandcastleSiegeShell';
import { currentGradeOf } from '@/lib/kids/grade';

const SKILL_SUBJECT = 'math' as const;

export default async function SandcastleSiegePage() {
