// `/games/cakey-road` — Cakey Road, a Crossy-Road-style hopper starring the
// kid's own Cakey Store cupcake, with math-gate checkpoints.
...
import CakeyRoadShell from './CakeyRoadShell';
...
export default async function CakeyRoadPage() {
  ...
  // The hopper IS the kid's Cakey Store cupcake. Guests / missing rows fall
  // back to the plain starter inside buildCupcakeModel (no regression).
