// `/games/cakey-crane` — crane-drop cake stacker with physics offcuts + math gates.
...
import CakeyCraneShell from './CakeyCraneShell';
...
const GAME_SLUG = 'cakey-crane';

export default async function CakeyCranePage() {
