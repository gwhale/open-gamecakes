// `/games/pit-stop` — Cakey Pit Stop, Race Island's pit-lane drill. A car pulls
// into the box, four jobs are worked against a running clock, it leaves, another
// arrives. Fills the Pit Row slot reserved in docs/race-island-plan.md §6.
...
import PitStopShell from './PitStopShell';
...
export default async function PitStopPage() {
  ...
  // The kid's Cakey Store cupcake stands in the box as the crew chief. Guests /
  // missing rows fall back to the plain starter inside buildCupcakeModel.
