// `/games/castle-crumble` — 3D cake-castle demolition puzzle with math gates.
...
import CastleCrumbleShell from './CastleCrumbleShell';
import { currentGradeOf } from '@/lib/kids/grade';

const SKILL_SUBJECT = 'math' as const;

export default async function CastleCrumblePage() {
