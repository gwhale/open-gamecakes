...
export const STORY_EVENTS: readonly StoryEvent[] = [
  {
    slug: 'puzzle-island-opens',
    icon: '🧩',
    title: 'A puzzle island appeared out at sea!',
    blurb: 'A quiet island for brain games — and a second ferry to take you there.',
    // Global, like race-island-opens: the dock, the trail and the blue boat are
    // built for EVERY kid, so this is a real announcement, not a tease. The
    // third beat teaches the one thing a kid could get wrong — there are two
    // boats now, and the colour is how you tell them apart.
    beats: [
      'Look out past the castle… a new island!',
      'It is Puzzle Island. Games you solve by THINKING.',
      'A second Cakey Ferry waits at a glowing blue dock.',
      'Purple boat goes to Chess. Blue boat goes to puzzles!',
      'Save up your Sugar Tokens and sail over. 🧩',
    ],
    regionSlug: 'puzzle-isle',
    style: 'arrival',
    trigger: { kind: 'global' },
  },
  {
    slug: 'sunken-batterlands-opens',
    icon: '🤿',
    title: 'There is a submarine at Caramel Cove!',
    blurb: 'It dives under the island, into an ocean nobody has been to yet.',
    // Beat three is doing the same job the race-island story's bridge beat
    // does: teaching the rule BEFORE the kid meets it. Sonar is the whole
    // mechanic and it is not obvious, so a kid who never presses it plays a
    // driving game in an empty sea and concludes there is nothing down there.
    beats: [
      'Someone tied a little submarine up at Caramel Cove…',
      'Walk out on the pier and climb in. It goes DOWN.',
      'Press SONAR and a ring spreads out — it tells you how far, and which way to steer.',
      'Something is hiding in the reef. The sonar knows where.',
      'Go deep enough and the boat says no… and something glows below. 🤿',
    ],
    regionSlug: 'caramel-cove',
    style: 'arrival',
    // Only kids who own the cove. A global trigger would advertise a place a
    // kid cannot reach, which is a tease rather than an announcement — and the
    // dock is not even built in their world.
    trigger: { kind: 'region-discovered', regionSlug: 'caramel-cove' },
  },
  {
