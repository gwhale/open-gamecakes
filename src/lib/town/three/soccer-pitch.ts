...
export function pitchCenterPx(
  ...
  const nd = (x: number, y: number): number =>
    beanNd(main.center.x, main.center.y, main.halfW, main.halfH, main.pad, main.stretch, x, y, main.cove);
  ...
  for (let i = 0; i < 64; i += 1) {
    ...
    const r = beanShoreDist(main.halfW, main.halfH, main.pad, main.stretch, ang, main.cove);
