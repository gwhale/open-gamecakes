...
export const WORLD = {
  ...
  WAFER:              0xe7c48a, // biscuit "pebble" prop — also Puzzle Island's waffle bake
  WAFFLE_GROOVE:      0xcf9a52, // the waffle's pocket grooves (cookieMat's default brown)
  ...
  // Cake Shift's layer ladder, size 1 (little, top) → 8 (big, base). A value
  // ramp, light to dark, so a layer's size reads by colour as well as by radius
  // — colour-blind kids, and everyone at a glance — and the rule becomes
  // learnable: heavy things are dark and go underneath. Every entry is an
  // existing token; index 5 is GUMDROP[4] (grape), spelled out because an
  // object literal cannot read its own sibling. At three layers the kid gets
  // cream / gold / strawberry — the brand cake.
  CAKE_TIERS: [
    0xfef3c7, // CAKE.VANILLA
    0xfde68a, // CAKE.VANILLA_DEEP
    0xfbbf24, // CAKE.AMBER
    0xfb7185, // CAKE.STRAWBERRY
    0xe11d48, // CAKE.STRAWBERRY_DEEP
    0xc084fc, // GUMDROP[4] grape
    0x7e22ce, // RIBBON.PURPLE_DEEP
    0x78350f, // CAKE.CHOCOLATE
  ] as const,
} as const;
